...
def playerCellMoving(pygame, mapBorders, PURPLE, PLAYER_SIZE, X_PLAYER_CELL, Y_PLAYER_CELL):
    F = 15
    m = 1

    dnfX = lambda x, s, ds: F/m

    startPoint = np.array([X_PLAYER_CELL, Y_PLAYER_CELL])
    ...
    playerCell = pygame.draw.circle(mapBorders, PURPLE, (b, newPoint[0]), PLAYER_SIZE)
